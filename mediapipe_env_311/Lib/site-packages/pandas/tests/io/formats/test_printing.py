...
c        ff         """
    ...
    def test_justify(self):
        ...
        assert just("", 5, mode="left") == ""
        assert just("", 5, mode="center") == ""
        assert just("", 5, mode="right") == ""

        assert just("", 10, mode="left") == "    "
        assert just("", 10, mode="center") == "    "
        assert just("", 10, mode="right") == "    "
    ...
    def test_east_asian_len(self):
        ...
        assert adj.len("") == 6
        assert adj.len("") == 5
        assert adj.len("panda") == 11
        assert adj.len("panda") == 10

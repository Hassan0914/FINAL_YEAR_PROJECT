...
class TestCategoricalIndexRepr:
    ...
    def test_string_categorical_index_repr(self):
        ...
        expected = """CategoricalIndex(['', '', ''], categories=['', '', ''], ordered=False, dtype='category')"""  # noqa: E501
        assert repr(idx) == expected

        # multiple lines
        idx = CategoricalIndex(["", "", ""] * 10)
        ...
        # truncated
        idx = CategoricalIndex(["", "", ""] * 100)
        expected = """CategoricalIndex(['', '', '', '', '', '', '', '', '', '',
                  ...
                  '', '', '', '', '', '', '', '', '', ''],
                 categories=['', '', ''], ordered=False, dtype='category', length=300)"""  # noqa: E501

        assert repr(idx) == expected

        # larger categories
        idx = CategoricalIndex(list(""))
        expected = """CategoricalIndex(['', '', '', '', '', '', '', '', '', '', '', '',
                  '', '', ''],
                 categories=['', '', '', '', ..., '', '', '', ''], ordered=False, dtype='category')"""  # noqa: E501

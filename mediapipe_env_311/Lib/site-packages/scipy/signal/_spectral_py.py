...
def lombscargle(
    ...
    *,
    ...
    ``y() = a*cos(*x) + b*sin(*x) + c``, where the fit is calculated for
    each frequency independently. This algorithm was developed by Zechmeister
    and Krster which improves the Lomb-Scargle periodogram by enabling
    ...
    y : array_like
        ...
        to True.
    freqs : array_like
        Angular frequencies (e.g., having unit rad/s=2/s for `x` having unit s) for
    ...
    .. [3] M. Zechmeister and M. Krster, "The generalised Lomb-Scargle periodogram.

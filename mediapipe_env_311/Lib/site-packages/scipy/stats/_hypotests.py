...
def _psi1_mod(x):
    """
    psi1 is defined in equation 1.10 in Csrg, S. and Faraway, J. (1996).
...
def _cdf_cvm_inf(x):
    """
    Calculate the cdf of the Cramr-von Mises statistic (infinite sample size).

    See equation 1.2 in Csrg, S. and Faraway, J. (1996).
...
def _cdf_cvm(x, n=None):
    """
    Calculate the cdf of the Cramr-von Mises statistic for a finite sample
    size n. If N is None, use the asymptotic cdf (n=inf).

    See equation 1.8 in Csrg, S. and Faraway, J. (1996) for finite samples,
    ...
    and 1, respectively. These are limitations of the approximation by Csrg
...
def _pval_cvm_2samp_exact(s, m, n):
    ...
    [1] Y. Xiao, A. Gordon, and A. Yakovlev, "A C++ Program for
        the Cramr-Von Mises Two-Sample Test", J. Stat. Soft.,
